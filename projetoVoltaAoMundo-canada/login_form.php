...
<body class="text-center flex-column">
  <h1 class="font-weight-bold text-dark">Portal Canada - ADM</h1>
  <form action="usuario-login.php" method="post" class="form-signin" name="login" onsubmit="return validaCampo(); return false;">
